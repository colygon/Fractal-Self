...
export default {
  ...
  pisa: {
    name: 'Pisa',
    emoji: '🏗️',
    prompt: 'Place the person or people in front of the Leaning Tower of Pisa. It is crucial to maintain their exact facial features, expressions, and character. Dress them in stylish Italian fashion. Create realistic shadows and warm highlights consistent with bright Tuscan sunlight. If there are multiple people, apply the fashion and lighting effects consistently to all, maintaining character consistency.',
    category: 'location',
  ...
  labubu: {
    name: 'Labubu',
    emoji: '🧸',
    prompt: 'Create a highly realistic, professional photograph of the person or people holding a cute furry Labubu plush toy in their hands. It is absolutely crucial to preserve their exact facial features, expressions of joy and affection, body proportions, and character - they must look exactly like themselves. The Labubu should be the authentic fuzzy, furry plush version with soft fabric texture and its distinctive features: pointy elf-like ears, small fanged teeth, large round black eyes, and its signature mischievous but adorable expression. The toy should have a fluffy, cuddly appearance with visible soft fur texture, not hard plastic. The toy should be properly sized (about 3-4 inches tall) and positioned naturally in their hands or arms as if they\'re showing off their precious collectible plushie. Their expression should show genuine happiness and pride in their furry Labubu, as collectors do with their favorite figures. The lighting should be natural and warm, highlighting both the person and the soft, fuzzy texture of the Labubu toy. The background should remain unchanged from the original photo. Ensure all figures are portrayed in a flattering, natural, and realistic way. If there are multiple people, give each person their own unique furry Labubu figure to hold, maintaining perfect character consistency. The final image should look like a genuine photograph of Labubu collectors proudly displaying their beloved fuzzy toys.',
    category: 'character',
