...
export default {
  ...
  berlin: {
    name: 'BERLIN',
    emoji: '🎧',
    prompt: 'Transform the person or people into a world-class DJ performing at a legendary Berlin techno club. It is absolutely crucial to preserve their exact facial features, expressions, body proportions, and character - they must look exactly like themselves as a professional DJ. Position them behind professional DJ decks with multiple CDJs, mixers, and controllers, hands actively working the equipment in a realistic DJ pose. Dress them in stylish black techno club attire - black leather jacket, dark jeans, or sleek all-black outfit that looks professional yet underground. The setting should be an epic Berlin techno club with soaring concrete ceilings, industrial architecture, and a massive dance floor packed with enthusiastic ravers. Create incredible lighting effects with powerful laser beams cutting through thick fog and haze, strobing lights in blues, purples, and whites, and dramatic spotlights illuminating the DJ booth. The crowd should be visible in the background, hands in the air, completely lost in the music. The atmosphere should capture the intense energy and euphoria of peak-time Berlin techno with realistic club lighting, professional sound equipment, and authentic club architecture. Ensure all figures are portrayed in a flattering, natural, and realistic way as talented DJs commanding the dance floor. Apply all changes consistently to everyone, maintaining character consistency.',
    category: 'location',
    postcardText: 'Headlining Berlin! 🎧✨'
  },
